...
public class Homework1 {
    ...
    public void streamPipeline1() {
        Arrays.stream(java.lang.String.class.getDeclaredMethods()).map(s -> s.getName()).sorted().forEach(System.out::println);
    }
    ...
    public void streamPipeline4() {
        Arrays.stream(java.lang.String.class.getDeclaredMethods()).map(s -> s.getReturnType()).distinct().sorted(Comparator.comparing(r -> r.getName())).forEach(System.out::println);
    }
    ...
    public void streamPipeline12() {
        Arrays.stream(java.lang.String.class.getDeclaredMethods()).flatMap(s -> Arrays.stream(s.getParameterTypes())).distinct().sorted(Comparator.comparing(p -> p.getName())).forEach(System.out::println);
    }
